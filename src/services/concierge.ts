...
const recipeCatalog: RecipeMatch[] = [
  ...
  {
    keywords: ["cake", "cakes", "chocolate cake", "birthday cake", "layer cake", "cupcake", "cupcakes", "dessert", "desserts", "baking", "bake", "baked"],
    title: "Chocolate Cake",
    cuisine: "Dessert",
    description: "A rich, moist chocolate cake with a tender crumb and a glossy finish that feels perfect for celebrations or a cozy dessert night.",
    ingredients: [{ name: "Flour", qty: "2 cups" }, { name: "Cocoa powder", qty: "3/4 cup" }, { name: "Sugar", qty: "2 cups" }, { name: "Eggs", qty: "2" }, { name: "Buttermilk", qty: "1 cup" }, { name: "Butter", qty: "1/2 cup" }],
    steps: ["Whisk the dry ingredients together until evenly combined.", "Mix the wet ingredients and fold them into the batter until smooth.", "Bake until the center springs back lightly and the top is set.", "Cool completely and finish with frosting or a dusting of cocoa."],
    estimatedCost: 11.8,
    costPerServing: 2.95,
    servings: 8,
    recipeId: "r21",
    ...
    toolIds: ["k1", "k17"],
    artistId: "a2",
    vibe: "Sweet and celebratory",
    budgetLabel: "Dessert for a crowd",
  },
  {
    keywords: ["cookie", "cookies", "chocolate chip cookie", "chocolate chip cookies"],
    title: "Chocolate Chip Cookies",
    cuisine: "Dessert",
    description: "Soft, chewy cookies with melted chocolate pockets and a warm, bakery-style finish.",
    ingredients: [{ name: "Flour", qty: "2 1/4 cups" }, { name: "Butter", qty: "1 cup" }, { name: "Sugar", qty: "3/4 cup" }, { name: "Brown sugar", qty: "3/4 cup" }, { name: "Chocolate chips", qty: "2 cups" }],
    steps: ["Cream the butter and sugars until light and fluffy.", "Fold in the dry ingredients until a soft dough forms.", "Stir in the chocolate chips and scoop the dough onto a tray.", "Bake until the edges are golden and the centers still look just soft."],
    estimatedCost: 8.4,
    costPerServing: 1.05,
    servings: 12,
    recipeId: "r22",
    ...
    toolIds: ["k1", "k17"],
    artistId: "a2",
    vibe: "Warm and nostalgic",
    budgetLabel: "Easy baking win",
  },
  {
    keywords: ["brownie", "brownies", "fudgy brownie", "fudgy brownies"],
    title: "Fudgy Brownies",
    cuisine: "Dessert",
    description: "Dense, rich brownies with crackly tops and a gooey chocolate center that feels indulgent without extra fuss.",
    ingredients: [{ name: "Butter", qty: "1/2 cup" }, { name: "Sugar", qty: "1 cup" }, { name: "Eggs", qty: "2" }, { name: "Cocoa powder", qty: "1/3 cup" }, { name: "Flour", qty: "1/2 cup" }],
    steps: ["Melt the butter and whisk in the sugar and eggs.", "Fold in cocoa and flour until just combined.", "Pour into a pan and bake until the center is set but still soft.", "Cool before slicing into thick squares."],
    estimatedCost: 7.8,
    costPerServing: 1.95,
    servings: 8,
    recipeId: "r23",
    ...
    toolIds: ["k1", "k17"],
    artistId: "a2",
    vibe: "Rich and decadent",
    budgetLabel: "Quick dessert fix",
  },
  {
    keywords: ["pie", "pies", "apple pie", "fruit pie"],
    title: "Classic Apple Pie",
    cuisine: "Dessert",
    description: "A golden pie filled with cinnamon-spiced apples and a flaky crust that feels comforting and homey.",
    ingredients: [{ name: "Pie crust", qty: "2 rounds" }, { name: "Apples", qty: "6" }, { name: "Sugar", qty: "3/4 cup" }, { name: "Cinnamon", qty: "2 tsp" }, { name: "Butter", qty: "2 tbsp" }],
    steps: ["Slice the apples and toss them with sugar and cinnamon.", "Fill the pie crust and dot with butter.", "Top with the second crust and seal the edges.", "Bake until the crust is deeply golden and the filling bubbles."],
    estimatedCost: 10.6,
    costPerServing: 2.65,
    servings: 8,
    recipeId: "r24",
    ...
    budgetLabel: "Weekend baking project",
  },
  {
    keywords: ["pastry", "pastries", "croissant", "croissants"],
    title: "Buttery Pastries",
    cuisine: "Dessert",
    description: "Flaky, buttery pastries with a crisp shell and tender center that feel bakery-worthy with very little effort.",
    ingredients: [{ name: "Pastry dough", qty: "1 sheet" }, { name: "Butter", qty: "4 tbsp" }, { name: "Sugar", qty: "2 tbsp" }, { name: "Egg", qty: "1" }, { name: "Vanilla", qty: "1 tsp" }],
    steps: ["Roll the dough and layer on butter for a flaky finish.", "Fold and chill briefly so the pastry stays crisp.", "Brush with egg wash and sprinkle with sugar.", "Bake until deeply golden and puffed."],
    estimatedCost: 9.2,
    costPerServing: 2.3,
    servings: 6,
    recipeId: "r25",
    ...
    toolIds: ["k1", "k17"],
    artistId: "a2",
    vibe: "Flaky and elegant",
    budgetLabel: "Treat-yourself baking",
  },
  {
